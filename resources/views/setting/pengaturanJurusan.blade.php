    ...
    <div class="col-md">
        <div class="bgku2">
            ...
            <div class="form-group">
                <label for="jurusanset">Tambah Posisi</label>
                <input type="text" class="form-control" name="jurusan" id="jurusanset" placeholder=" guru, anggota atau pengunjung" value="{{old("jurusan")}}">
            </div>

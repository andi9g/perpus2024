...
<head>
  ...
  <style>
    .mybg2 {
      background: rgb(0,108,237);
background: linear-gradient(180deg, rgba(0,108,237,0.3337710084033614) 0%, rgba(194,237,255,0) 100%);
    }
  </style>
</head>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-secondary elevation-4 bg-primary">
      <!-- Brand Logo -->

      <a href="{{ url('/', []) }}" class="brand-link text-dark ">
                                               
        <span class="brand-text font-weight-light judul text-uppercase"><b>Aplikasi Perpustakaan</b></span>
      </a>

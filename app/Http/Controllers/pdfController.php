...
class pdfController extends Controller
{
    ...
    public function cetakPeminjaman(Request $request)
    {
        ...
        try{
            ...
            $nama_perpus = DB::table('tb_pengaturan')->first();
            $nama_perpus = empty($nama_perpus->nama_perpus)?"":$nama_perpus->nama_perpus;

            $ket = "Laporan Peminjaman";

            $peminjaman = logpeminjaman::join('tb_buku', 'tb_buku.kd_buku', 'log_peminjaman.kd_buku')
            ->join('tb_anggota', 'tb_anggota.nis', 'log_peminjaman.nis')
            ->orderBy('log_peminjaman.created_at', 'asc')
            ->select('tb_anggota.*','tb_buku.*','log_peminjaman.*')
            ->whereBetween('log_peminjaman.created_at', [$tanggalawal, $tanggalakhir])
            ->get();
            // dd($peminjaman);

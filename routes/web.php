...
Route::get('cetak/peminjaman', 'pdfController@cetakPeminjaman')->name('cetak.peminjaman');
Route::get('cetak/pengembalian', 'pdfController@cetakPengembalian')->name('cetak.pengembalian');
// Route::get('/cetak/{laporan}/{ket}', 'pdfController@cetakAnggota');
Route::get('laporan', 'pdfController@laporan');
